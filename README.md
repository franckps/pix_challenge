...
## JSON para importar no Insomnia ( [Abrir arquivo JSON](https://github.com/franckps/pix_challenge/blob/main/asset/json%20para%20importar%20no%20insomnia%20workspace.json) )
